...
class ProjectCardComponentOld extends StatefulWidget {
  final String imagePath;
  final String projectName;
  final String projectDescription;
  final Color primaryProjectColor;
  final Color secondaryProjectColor;
  const ProjectCardComponentOld({
    super.key,
  ...
  @override
  State<ProjectCardComponentOld> createState() => _ProjectCardComponentOldState();
}

class _ProjectCardComponentOldState extends State<ProjectCardComponentOld> {
