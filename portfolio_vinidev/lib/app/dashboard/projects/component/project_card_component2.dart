...
class ProjectCardComponent2 extends StatefulWidget {
  final void Function()? onTap;
  final String imagePath;
  final Color primaryProjectColor;

  const ProjectCardComponent2({
    super.key,
    required this.onTap,
  ...
  @override
  State<ProjectCardComponent2> createState() => _ProjectCardComponent2State();
}

class _ProjectCardComponent2State extends State<ProjectCardComponent2> {
  @override
