...
class ContactDesktopView extends StatefulWidget {
  ...
  @override
  State<ContactDesktopView> createState() => _ContactDesktopViewState();
}

class _ContactDesktopViewState extends State<ContactDesktopView> {
  @override
